...
class TypedGherkinFeaturePrompt(TypedPrompt):
    ...
    sys_msg: str = "You are a Gherkin feature file creation AI assistant that crafts " \
...
if __name__ == "__main__":
    ...
    generated_gherkin = gherkin_prompt(user_input=user_input_data, to="text_game.feature")
