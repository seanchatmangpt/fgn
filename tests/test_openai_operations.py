...
from fgn.utils.llm_operations import complete
...
def test_complete_with_functions():
    ...
    with patch("fgn.utils.llm_operations.openai.ChatCompletion.create") as mock_create:
        ...
        result = complete("prompt", funcs=[custom_function])
...
def test_complete_with_functions2():
    ...
    with patch(
        ...
        result = complete(prompt, funcs=[change_value_function])
...
def test_openai_weather_interaction():
    ...
    with requests_mock.Mocker() as m:
        ...
        with patch("openai.ChatCompletion.create") as mock_create:
            ...
            result = complete(prompt, funcs=[get_current_weather_function])

            assert result == {'name': 'get_current_weather', 'arguments': {'location': 'Boston, MA'}}
            ...
            final_result = complete(msgs=updated_prompt, funcs=[get_current_weather_function])
