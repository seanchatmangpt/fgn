...
class Tree:
    ...
    def add_node(
        self, new_node: Tuple[float, float], parent: Tuple[float, float]
    ) -> None:
        pass
...
class PKERRTAgent:
    ...
    def assess_pkerrt_efficiency(
        self, start_point: Tuple[float, float], goal_points: List[Tuple[float, float]]
    ) -> float:
        """
